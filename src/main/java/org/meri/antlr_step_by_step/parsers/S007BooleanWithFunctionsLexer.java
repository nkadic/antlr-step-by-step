// $ANTLR 3.5.2 org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g 2018-10-21 20:12:25
...
public class S007BooleanWithFunctionsLexer extends Lexer {
	...
	public final void mT__15() throws RecognitionException {
		try {
			...
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:18:7: ( ',' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:18:9: ','
			{
			match(','); 
			}
	...
	public final void mLPAREN() throws RecognitionException {
		try {
			int _type = LPAREN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:43:8: ( '(' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:43:10: '('
			{
			match('('); 
			}
	...
	public final void mRPAREN() throws RecognitionException {
		try {
			int _type = RPAREN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:44:8: ( ')' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:44:10: ')'
			{
			match(')'); 
			}
	...
	public final void mAND() throws RecognitionException {
		try {
			int _type = AND;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:45:5: ( '&&' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:45:7: '&&'
			{
			match("&&"); 
	...
	public final void mOR() throws RecognitionException {
		try {
			int _type = OR;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:46:4: ( '||' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:46:6: '||'
			{
			match("||"); 
	...
	public final void mNOT() throws RecognitionException {
		try {
			int _type = NOT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:47:5: ( '!' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:47:7: '!'
			{
			match('!'); 
			}
	...
	public final void mALL() throws RecognitionException {
		try {
			int _type = ALL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:49:5: ( 'all' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:49:7: 'all'
			{
			match("all"); 
	...
	public final void mATLEASTONE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:50:12: ( 'atleastone' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:50:14: 'atleastone'
			{
			match("atleastone"); 
	...
	public final void mNEITHER() throws RecognitionException {
		try {
			int _type = NEITHER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:51:9: ( 'neither' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:51:11: 'neither'
			{
			match("neither"); 
	...
	public final void mNOTALL() throws RecognitionException {
		try {
			int _type = NOTALL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:52:8: ( 'notall' )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:52:10: 'notall'
			{
			match("notall"); 
	...
	public final void mNAME() throws RecognitionException {
		try {
			int _type = NAME;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:54:6: ( ( 'a' .. 'z' | '0' .. '9' )+ )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:54:8: ( 'a' .. 'z' | '0' .. '9' )+
			{
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:54:8: ( 'a' .. 'z' | '0' .. '9' )+
			int cnt1=0;
			loop1:
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:55:4: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:55:6: ( ' ' | '\\t' | '\\r' | '\\n' )+
			{
			// org\\meri\\antlr_step_by_step\\parsers\\S007BooleanWithFunctions.g:55:6: ( ' ' | '\\t' | '\\r' | '\\n' )+
			int cnt2=0;
			loop2:
